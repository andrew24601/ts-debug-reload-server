 ...
 */
 class ESMImportTransformer extends _Transformer2.default {
  ...
  constructor(
    ...
    super();this.tokens = tokens;this.nameManager = nameManager;this.reactHotLoaderTransformer = reactHotLoaderTransformer;this.isTypeScriptTransformEnabled = isTypeScriptTransformEnabled;this.options = options;;
  ...
  processImport() {
    ...
    if (this.tokens.matches2(_types.TokenType._import, _types.TokenType.string) && this.options.moduleResolver != null) {
      // String import gets special handling
